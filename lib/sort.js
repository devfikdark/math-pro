 ...
 */
export function bubbleSort(array, type) {
 ...
 */
export function insertionSort(array, type) {
 ...
 */
export function mergeSort(array, type) {
  if (array.length <= 1) {
    return array;
  } else {
 ...
 */
export function selectionSort(array, type) {
  if (type === undefined) type = "asc";
  let index = 0,
    length = array.length,
    nextElementIndex = 0;
 ...
 */
export function quickSort(array, type) {
  if (type === undefined) type = "asc";
  if (array.length <= 1) {
    return array;
  }
