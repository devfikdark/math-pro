 ...
 */
const bubbleSort = (array:any, type = "asc") => {
 ...
 */
const insertionSort = (array:any, type = "asc") => {
 ...
 */
const mergeSort = (array:any, type = "asc"):any => {
  if (array.length <= 1) {
    return array;
  } else {
...
function merge(leftArr:any, rightArr:any, type:any) {
  if (type === undefined) type = "asc";
  let sortedArr = [];
 ...
 */
const selectionSort = (array:any, type = "asc") => {
  if (type === undefined) type = "asc";
  let index = 0,
    length = array.length,
    nextElementIndex = 0;
 ...
 */
const quickSort = (array:any, type = "asc"):any => {
  if (type === undefined) type = "asc";
  if (array.length <= 1) {
    return array;
  }
